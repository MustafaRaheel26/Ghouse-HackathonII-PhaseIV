        ...
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              ...
              // Focus glow - ring-2 ring-orange-500/20
              "focus:outline-none focus:ring-2",
              hasError
                ? "border-rose-500 focus:border-rose-500 focus:ring-rose-500/20"
                : "border-slate-200 focus:border-orange-500 focus:ring-orange-500/20 dark:border-slate-700 dark:focus:border-orange-400 dark:focus:ring-orange-400/20",
