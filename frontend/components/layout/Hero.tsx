      ...
      >
        <div className="max-w-2xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter leading-tight mb-4 text-foreground">
            Welcome back,{" "}
            <span className="text-gradient italic">{userName}</span>
            <span className="ml-2 inline-block text-lg font-medium align-middle opacity-60">
              —
            </span>
          </h1>
          ...
          <p className="text-lg opacity-70 font-medium mb-6">
            You have{" "}
            <span className="font-black text-foreground">{pending}</span>{" "}
            pending initiatives. Activate the mission control to deploy your
            next objective.
          </p>
          ...
          <div className="flex items-center gap-4">
            <Button
              ...
              className="neon h-14 rounded-2xl font-black"
            >
              Launch Task
            </Button>
            <Button
        ...
        >
          ...
          <div className="glass-premium rounded-2xl p-6 border border-white/10 shadow-xl">
            ...
            <div className="mt-3">
              <h4 className="text-lg font-black">TaskZone Snapshot</h4>
              <p className="text-sm opacity-70">
                Trends, completion velocity, and quick actions — condensed into
                one glance.
              </p>
            </div>
          </div>
