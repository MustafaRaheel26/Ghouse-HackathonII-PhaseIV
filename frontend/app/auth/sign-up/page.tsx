...
import { ArrowRight, Flame, UserPlus, Sparkles } from "lucide-react";
    ...
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-6 relative overflow-hidden auth-background">
      ...
      <div
        ...
        style={{
          ...
          right: "-10rem",
          background:
            "radial-gradient(circle at 80% 20%, rgba(249,115,22,0.9), rgba(245,158,11,0.4))",
        }}
      />
      <div
        ...
        style={{
          ...
          left: "-6rem",
          background:
            "radial-gradient(circle at 20% 80%, rgba(249,94,19,0.85), rgba(245,158,11,0.4))",
          animationDelay: "1.2s",
        }}
      />
      <div
        ...
        style={{
          ...
          left: "-4rem",
          background:
            "radial-gradient(circle at 30% 30%, rgba(249,115,22,0.65), rgba(245,158,11,0.2))",
          animationDelay: "2.8s",
        }}
      />
      ...
      <div className="w-full max-w-md animate-welcome z-10">
        <div className="glass-premium rounded-[2.5rem] p-8 md:p-10 border border-white/20 relative z-10">
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <h2 className="h2 mb-2">Join TaskZone Heat</h2>
            <p className="body text-base opacity-70">
              Start your journey into a blazing new productivity era.
            </p>
          </div>
