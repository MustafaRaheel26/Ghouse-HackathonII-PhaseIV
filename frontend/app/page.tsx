    ...
    <div className="min-h-[calc(100vh-80px)] overflow-x-hidden bg-background">
      ...
      <section className="section-horizontal section-vertical bg-muted/30 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="h2 mb-4">Why TaskZone Heat?</h2>
            <p className="body">
              A blazing interface and performance crafted for scorched-earth
              productivity.
            </p>
          </div>
      ...
      <footer className="py-20 px-6 border-t border-ui-border/20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2 space-y-6">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary text-white shadow-lg shadow-orange-500/30">
            ...
            <p className="body max-w-sm">
              The premium way to organize your life and tasks. Beautifully
              designed, intelligently built.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-ui-border/10 text-center text-sm font-bold opacity-30">
          &copy; 2026 TaskZone Heat. All rights reserved.
        </div>
      </footer>
    </div>
  );
