...
import { ArrowRight, Flame, Lock, Mail, Sparkles } from "lucide-react";
    ...
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-6 relative overflow-hidden auth-background">
      ...
      <div
        ...
        style={{
          ...
          left: "-10rem",
          background:
            "radial-gradient(circle at 20% 30%, rgba(249,115,22,0.9), rgba(245,158,11,0.5))",
        }}
      />
      <div
        ...
        style={{
          ...
          right: "-6rem",
          background:
            "radial-gradient(circle at 70% 70%, rgba(249,94,19,0.85), rgba(245,158,11,0.4))",
          animationDelay: "1.5s",
        }}
      />
      <div
        ...
        style={{
          ...
          right: "-4rem",
          background:
            "radial-gradient(circle at 40% 40%, rgba(249,115,22,0.7), rgba(249,94,19,0.2))",
          animationDelay: "3s",
        }}
      />
      ...
      <div className="w-full max-w-md animate-welcome z-10">
        <div className="glass-premium rounded-[2.5rem] p-8 md:p-10 border border-white/20 relative z-10">
          <div className="flex flex-col items-center text-center mb-10">
            <div className="w-16 h-16 rounded-2xl bg-primary flex items-center justify-center text-white shadow-xl shadow-orange-500/30 mb-6 animate-float">
              <Flame className="w-10 h-10" />
            </div>
            <h2 className="h2 mb-2">Welcome Back</h2>
            <p className="body text-base opacity-70">
              Experience the fiery productivity.
            </p>
          </div>
