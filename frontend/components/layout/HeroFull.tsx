  ...
  return (
    <header className="min-h-[calc(100vh-80px)] relative flex items-center justify-center text-center overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <div className="absolute -left-40 top-10 w-96 h-96 rounded-full bg-gradient-to-tr from-orange-400 to-yellow-400 opacity-40 blur-3xl animate-blob" />
        <div
          className="absolute right-[-8rem] bottom-0 w-96 h-96 rounded-full bg-gradient-to-br from-red-500 to-yellow-300 opacity-30 blur-3xl animate-blob"
      ...
      >
        ...
        <p className="text-xl md:text-2xl opacity-80 body max-w-3xl mx-auto mb-10">
          Experience the fiery productivity: blazing visuals, rapid
          interactions, and molten motion—designed to set your workflow ablaze.
        </p>
        ...
        <div className="flex items-center justify-center gap-4">
          <Link href="/auth/sign-up">
            <Button
              variant="primary"
              size="lg"
              className="h-16 px-10 rounded-2xl neon"
            >
