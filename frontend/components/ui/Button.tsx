...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantClasses: Record<ButtonVariant, string> = {
      // Primary variant - orange with hover lift
      primary:
        "bg-primary text-white shadow-md hover:shadow-lg hover:bg-primary-hover active:bg-orange-700 disabled:bg-slate-300 disabled:text-slate-500",
