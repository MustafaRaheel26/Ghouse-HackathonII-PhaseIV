...
import { Layout, Flame } from "lucide-react";
      ...
      <div className="section-horizontal py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          <div className="flex items-center gap-8">
            ...
            >
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-primary text-white shadow-lg shadow-orange-500/30 group-hover:shadow-orange-500/50 group-hover:rotate-6 transition-all duration-500">
                <Flame className="w-6 h-6" strokeWidth={3} />
              </div>
              <h1 className="text-2xl font-black tracking-tighter text-foreground leading-none">
                TaskZone <span className="text-primary italic">Heat</span>
              </h1>
            </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            {!pathname?.includes("/dashboard") && (
              <Link href="/dashboard" className="hidden sm:block">
                <button className="px-5 py-2.5 bg-primary text-white text-sm font-black rounded-xl hover:bg-orange-600 transition-all active:scale-95 shadow-lg shadow-primary/10">
                  Go to Workspace
                </button>
              </Link>
            )}
