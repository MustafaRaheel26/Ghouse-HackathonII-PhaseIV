  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-background">
      <div className="section-horizontal section-vertical max-w-7xl mx-auto">
        ...
        {/* Stats Grid */}
        <div
          className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-16 animate-welcome"
        ...
        >
          <div className="lg:col-span-3 glass-premium p-10 rounded-[3rem] relative overflow-hidden group border-white/10">
            ...
            <div className="relative z-10">
              <div className="flex justify-between items-end mb-8">
                <div>
                  <p className="text-xs font-black opacity-40 uppercase tracking-[0.3em] mb-3">
                    Productivity Pulse
                  </p>
              ...
              <div className="w-full h-3 bg-muted/30 rounded-full overflow-hidden mb-6 border border-ui-border/10 p-0.5">
                <div
                  className="h-full bg-gradient-to-r from-primary via-orange-400 to-yellow-400 rounded-full transition-all duration-1000 ease-out shadow-[0_0_15px_rgba(var(--primary),0.5)]"
          ...
          <div
            className="glass-premium p-10 rounded-[3rem] flex flex-col justify-between border-white/10 hover:border-primary/40 transition-all duration-500 group cursor-pointer"
          ...
          >
            <div>
              ...
              <p className="text-sm opacity-60 font-bold leading-relaxed">
                Instantly capture high-priority tasks in your ecosystem.
              </p>
            </div>
        ...
        <div
          className="flex items-center justify-between mb-10 animate-welcome"
          ...
          <div className="relative glass-premium w-full max-w-xl rounded-[3.5rem] p-10 md:p-14 border border-white/20 shadow-[0_50px_100px_rgba(0,0,0,0.4)] animate-in zoom-in-95 duration-500">
            <div className="flex items-center justify-between mb-12">
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="text-xs uppercase font-black opacity-40 tracking-widest">
            ...
            >
              <div className="space-y-3">
                <label className="text-[10px] font-black opacity-40 uppercase tracking-[0.4em] pl-1">
                  Objective Title
                </label>
                <Input
                  type="text"
